...
#set output "Levo_ls_comp_orange.pdf"
...
plot\
"Ltot_orbinit_ideal.dat"  u 1:($3/L_ini) w l lw 5 lc 6 t "Orbital",\
"Ltot_orbinit_ideal.dat"  u 1:($4/L_ini) w l lw 5 lc rgb "#E76E45" t "Spin",\
"Ltot_orbinit.dat"  u 1:($3/L_ini) w l lw 5 lc 6 dt (3,3) notitle,\
"Ltot_orbinit.dat"  u 1:($4/L_ini) w l lw 5 lc rgb "#E76E45" dt (3,3) notitle
set output  
unset label 1
unset label 2
